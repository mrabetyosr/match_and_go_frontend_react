...
import PaymentSuccess from '../../components/PaymentSuccess/PaymentSuccess.jsx'; // ✅ Nouveau import
  ...
  return (
    <div className="user-layout">
      ...
      <Routes>
        ...
        <Route path="payment-success" element={<PaymentSuccess />} /> {/* ✅ Nouvelle route */}
