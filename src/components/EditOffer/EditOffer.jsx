...
const EditOffer = ({ token, offer, onOfferUpdated, onClose }) => {
  ...
  // Pré-remplir le formulaire avec les données de l'offre existante
  useEffect(() => {
    if (offer) {
      setEditedOffer({
        jobTitle: offer.jobTitle || "",
        jobType: offer.jobType || "Internship",
        remote: offer.remote || false,
        jobSalary: offer.jobSalary || 0,
        duration: offer.duration || "",
        jobSlots: offer.jobSlots || 1,
        jobDate: offer.jobDate ? offer.jobDate.split('T')[0] : "",
  ...
  const handleArrayChange = (field, value) => {
    setEditedOffer({ ...editedOffer, [field]: value.split(",").map(v => v.trim()) });
  };

  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://localhost:7001/api/offers/update/${offer._id}`, editedOffer, {
        ...
        <div className="add-offer-header">
          <div className="header-content">
            ...
            <div>
              ...
              <p className="modal-subtitle">Update the details for your job posting</p>
            </div>
          </div>
              ...
              <div className="form-grid">
                ...
                <div className="form-group full-width">
                  ...
                  <input
                    type="date"
                    className="form-input"
                    value={editedOffer.applicationDeadline}
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={editedOffer.languages.join(", ")}
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={editedOffer.responsibilities.join(", ")}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={editedOffer.requirements.join(", ")}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={editedOffer.benefits.join(", ")}
